    ...
    <div class="works__content">
      <div class="filters">
        <ProjectFilter
          ...
          @click="selectedFilter = filterText"
        >
          {{ filterText === FILTER.SHOW_ALL ? t('works.filter-show-all') : filterText }}
        </ProjectFilter>
      </div>
      <div class="works__filters-subtitle">
        {{ t('works.filters-subtitle') }}
      </div>
      <TransitionGroup name="projects" class="projects" tag="div">
        <div
...
import personalWebsiteImg from '~/assets/images/works/personal-website.jpg'
import wordleVueImg from '~/assets/images/works/wordle-vue.png'
import pianoJsImg from '~/assets/images/works/piano-js.jpg'
import enveloppeVueImg from '~/assets/images/works/enveloppe-vue.png'
import winamaxLiveImg from '~/assets/images/works/winamax-live.jpg'
import githubRibbonImg from '~/assets/images/works/github-ribbon.png'
import { GITHUB_NAME } from '~/utils/constants'

definePageMeta({ name: 'works' })
...
const WORKS = [
  {
    ...
    projectImg: personalWebsiteImg,
    ribbonImg: githubRibbonImg,
    ribbonText: undefined as string | undefined,
    ribbonColor: '#333',
  ...
  {
    name: 'winamax live',
    projectImg: winamaxLiveImg,
    ribbonImg: undefined as string | undefined,
    ribbonText: 'winamax',
    ribbonColor: '#B71B1C',
    filters: [FILTER.WEB, FILTER.MOBILE, FILTER.REACT, FILTER.REACT_NATIVE],
    href: 'https://play.google.com/store/apps/details?id=com.winamax.events&hl=en_US'
  }
]

const selectedFilter = ref(FILTER.SHOW_ALL)

const visibleWorks = computed(() =>
  selectedFilter.value === FILTER.SHOW_ALL
    ? WORKS
    : WORKS.filter(w => w.filters.includes(selectedFilter.value))
)
</script>
